...
//		PImage img = loadImage("C:/Users/Caio/Desktop/matrix.jpg");
//		img.resize(800, 600);
//		this.background(img);
		...
		AbstractMapProvider temperatureProvider = new OpenWeatherProvider.Temperature();
		AbstractMapProvider msHybProvider = new Microsoft.HybridProvider();
	    ...
	    map2 = new UnfoldingMap(this, 400, 50, 350, 500, msHybProvider);
	    map2.zoomAndPanTo(zoomLevel, new Location(-22.952009, -43.210273));
		
		// This lines makes the maps interactive
